            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-dark/70 dark:text-white/70 text-lg leading-relaxed">
                  {selectedProject.description} Esta es una descripción detallada ficticia para demostrar el funcionamiento del modal. Aquí podrías incluir los retos técnicos, las soluciones implementadas y los resultados obtenidos.
                </p>
              </div>
